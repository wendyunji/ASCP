...
file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), f'../../Dataset/Tdataset/format/filtered_flights_{month}_*.csv'))
...
save_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../Dataset/Tdataset/deadhead'))
